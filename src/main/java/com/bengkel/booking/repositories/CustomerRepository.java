...
public class CustomerRepository {
	...
	public static List<Customer> getAllCustomer(){
		...
		Customer cust1 = new Customer("Cust-001", "Budi", "Bandung", "cust001", listCust1Vechicle, "None Member");
		
		//Customer 2
		Motorcyle motorCust2 = new Motorcyle("D6734ZD", "Merah", "Honda", "Otomatis", 2019, 125);		
		List<Vehicle> listCust2Vechicle = Arrays.asList(motorCust2);
		
		Customer cust2 = new Customer("Cust-002", "Yanto", "Bandung", "cust002", listCust2Vechicle, "None Member");
		...
		Customer cust3 = new MemberCustomer("Cust-003", "Rahmat", "Garut", "cust003", listCust3Vechicle,"Member" ,2000000);
